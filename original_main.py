...
# from .handlers import google_sheets_sync  # Временно отключено - нет зависимостей gspread
# from .handlers import plane_testing  # Временно отключено
...
async def main():
    ...
    try:
        ...
        # 1. Database Session - должен быть первым
        ...
        # dp.include_router(google_sheets_sync.router)  # Временно отключено
        # dp.include_router(plane_testing.router)  # Временно отключено
