...
def format_help_message() -> str:
    ...
    return (
        ...
        "*📝 Заявки в поддержку:*\n"
        "📋 `/request` \\- Создать заявку \\(в группе\\)\n"
        "_💡 Просто напишите /request, затем ответьте текстом проблемы\\._\n"
        "_Бот автоматически создаст заявку в Plane с вашим именем\\._\n\n"
        "*📋 Журнал работ:*\n"
        "Используйте главное меню или команды:\n"
        "📝 Создать запись \\- через кнопку в меню\n"
        "📊 История работ \\- просмотр всех записей\n"
        "📈 Отчеты \\- статистика по работам\n\n"
        "*🏢 Управление компаниями:*\n"
        "🏢 Список компаний \\- через меню\n"
        ...
        "🧪 `/plane_test` \\- Тест подключения к Plane\n\n"
        "*👑 Команды админов:*\n"
        "⚙️ `/setup_chat` \\- Настроить чат для заявок \\(в группе\\)\n"
        "📋 `/list_mappings` \\- Список настроенных чатов\n"
        "🗑️ `/remove_chat` \\- Удалить настройку чата \\(в группе\\)\n"
        "📊 `/requests_stats` \\- Статистика заявок\n\n"
        "*🔄 Синхронизация:*\n"
        "📊 `/sheets_sync` \\- Синхронизация с Google Sheets\n\n"
        "*Возможности журнала работ:*\n"
        "• Пошаговое заполнение записей\n"
        "• Поддержка разных форматов времени \\(часы/минуты\\)\n"
        ...
        "• Упоминания исполнителей в групповом чате\n\n"
        "*Поддерживаемые форматы времени:*\n"
        "• `2` \\- 2 часа \\(если число ≤ 10\\)\n"
        "• `90` \\- 90 минут\n"
        "• `2 часа`, `2ч`, `2 ч`\n"
        "• `30 минут`, `30мин`, `30 м`\n"
        "• `1\\.5 часа`, `1,5ч` \\- дробные часы\n\n"
